...
urlpatterns = [
    ...
    path("login-email/change/request/", views.request_login_email_change, name="request_login_email_change"),
    path("login-email/change/verify/", views.verify_login_email_change, name="verify_login_email_change"),
    ...
    path("account/change-password/", views.ChangePasswordAPIView.as_view(), name="change_password"),
